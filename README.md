...
This function is used in order to retrieve the relative distance and angle to a token that is in `code` which is a list containg codes of token passed as input.  
